...
export function IntroPage() {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-8 gap-6 max-w-md">
                {/* Eyebrow */}
                <motion.p
                ...
                >
                    Experiência<br />Farmácia<br />Amada Vivo
                </motion.h1>
                ...
                >
                    Esta é uma experiência de espelho virtual para simular maquiagem no seu rosto.
                    Avance pelas etapas para descobrir o que a IA preparou de ideal para você.
                </motion.p>
                ...
                <motion.button
                    ...
                    className="w-full max-w-xs px-8 py-4 rounded-2xl text-white font-semibold text-lg"
                    style={{
                        background: 'linear-gradient(135deg, #EC4899 0%, #8B5CF6 100%)',
